...
│
├── data/                              # Input data (satellite files excluded due to size)
...
# Step 3 & 4: Train model + inference (GPU required)
# Via SLURM:
sbatch run_gpu.sh
# Or directly:
python scripts/03_train_model.py && python scripts/04_inference.py
